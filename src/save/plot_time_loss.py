...
_0_6_acc = np.load('0.6_train_loss.npy')[::3]
_0_8_acc = np.load('0.8_train_loss.npy')[::3]
_1_0_acc = np.load('1.0_train_loss.npy')[::3]-0.1
...
fig.savefig('images/time_loss.pdf', format='pdf', bbox_inches='tight')
plt.close()
